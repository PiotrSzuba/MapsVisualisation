...
namespace Backend
{
    ...
    {
        /// <summary>
        /// model input class for MapDetection.
        /// </summary>
        ...
        /// <summary>
        /// model output class for MapDetection.
        /// </summary>
        #region model output class
        public class ModelOutput
        {
            public string[] ObjectTags = new string[] { "--bg--", "Map", };
        ...
        private static string MLNetModelPath = Path.GetFullPath("MapDetection.zip");
